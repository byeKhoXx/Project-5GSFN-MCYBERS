...
class MyTopo(Topo):
    def __init__(self):
        ...
        c1 = net.addHost( 'h1', ip="10.0.1.10/24", mac="00:00:00:00:00:01" )
        c2 = net.addHost( 'h2', ip="10.0.2.10/24", mac="00:00:00:00:00:02" )
        c3 = net.addHost( 'h3', ip="10.0.3.20/24", mac="00:00:00:00:00:03" )
        dynDNS = net.addHost( 'h4', ip="10.0.2.20/24", mac="00:00:00:00:00:04" )
        r1 = net.addHost( 'r1')
        s1 = net.addSwitch( 's1')
        s2 = net.addSwitch( 's2')
        ...
        c1.cmd("ifconfig c1-eth0 0")
        c1.cmd("ifconfig c1-eth0 hw ether 00:00:00:00:00:01")
        c1.cmd("ip addr add 10.0.1.10/24 dev c1-eth0")
